...
import { DatasetSnapshotDetailsComponent } from 'app/pages/datasets/components/dataset-snapshot-details/dataset-snapshot-details.component';
...
@NgModule({
  ...
  declarations: [
    ...
    DatasetSnapshotDetailsComponent,
